...
<div class="row">
				...
				<tfoot id="total-cart-here">
					<tr>
						<td style="border:none;" colspan="4" align="right">
							<h4 class="me-3 mt-3">Total Amount: <font id="total-amount-here">0.00</font></h4>
						</td>
					</tr>
				</tfoot>
			</table>
	...
	<div class="col-lg-4 item-cart-container p-3" style="height: 85vh">
		<div class="row mb-3">
			<div class="col-lg-12">
		...
		<div class="row mb-1">
			...
			<div class="col-lg-8">
				<input  name="txtICode" id="txtICode" class="form-control" onchange="getProductDetails(this.value)" autocomplete="off">
			</div>
		</div>
		<div class="row mb-1">
			<div class="col-lg-4">
